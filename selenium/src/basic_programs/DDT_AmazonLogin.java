...
public class DDT_AmazonLogin 
{
	public static void main(String[] args) throws EncryptedDocumentException, IOException
	{
		...
		String MNo=NumberToTextConverter.toText(wb.getSheet("amazon_login").getRow(1).getCell(0).getNumericCellValue());
		String psw=wb.getSheet("amazon_login").getRow(1).getCell(1).getStringCellValue();
		
		WebElement email=driver.findElement(By.xpath("//input[@id='ap_email']"));
		email.sendKeys(MNo);
		WebElement continue_btn=driver.findElement(By.xpath("//input[@id='continue']"));
		continue_btn.click();
		WebElement psw_tbox=driver.findElement(By.xpath("//input[@id='ap_password']"));
		psw_tbox.sendKeys(psw);
